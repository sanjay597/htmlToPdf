...
<head>
	...
	<script src="<?php echo base_url() ?>assets/js/editConvertPdf.js" defer></script>
</head>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<label>Agreement Title</label><input type="text" class="form-control" placeholder="Enter Agreement Title" id="agreement_title" />
			</div>
			<div class="col-lg-7">
			...
			<div class="col-lg-5">
				<label>Admin Comment</label><input type="text" id="admin_comment" class="form-control" placeholder="Enter Comment" />
			</div>
			...
			<div class="col-lg-12 text-center" id="updatePdf">
				<input type="button" value="Update PDF" class="btn btn-success" onclick="savePdfData();" />
			</div>
		</div>
